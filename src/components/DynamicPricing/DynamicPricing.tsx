...
export function DynamicPricing({
    ...
    return (
        <div className="space-y-2">
            ...
            <div>
                <Label className="text-[11px] text-white/70 mb-0.5 block">Desired # of Quote Casts</Label>
                <div className="flex items-center gap-2">
                    <Button
                        ...
                        className="h-8 w-8 bg-white/5 border-white/10 text-white hover:bg-white/10 hover:text-white shrink-0"
                    >
                    ...
                    <Input
                        ...
                        className="text-center text-sm font-semibold bg-white/5 border-white/10 text-white h-8 flex-1"
                    />
                    <Button
                        type="button"
                        variant="outline"
