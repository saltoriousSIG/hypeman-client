        ...
        <div className="fixed bottom-0 left-0 right-0 bg-black/90 backdrop-blur-xl border-t border-white/20 z-50">
            <div className="flex items-center">
                    <NavLink to="/" className="flex-1">
                        {({ isActive }) => (
                            <button 
                                className={`w-full flex items-center justify-center gap-2 px-6 py-6 text-white text-base font-semibold transition-all duration-300 border-r cursor-pointer ${
                                    isActive 
                    ...
                    <NavLink to="/manage" className="flex-1">
                        {({ isActive }) => (
                            <button 
                                className={`w-full flex items-center justify-center gap-2 px-6 py-6 text-white text-base font-semibold transition-all duration-300 cursor-pointer ${
                                    isActive 
